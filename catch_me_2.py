...
crow_img = pygame.transform.scale(crow_img, (200, 200))  # {{ edit_1 }}
crow_x = random.randint(0, SCREEN_WIDTH - 200)  # {{ edit_1 }}
crow_y = random.randint(0, SCREEN_HEIGHT - 200) #  // {{ edit_1 }}
...
while True:
    ...
    if not start_game:
        ...
        if mouse_pressed:
            ...
            if crow_x < mouse_x < crow_x + 200 and crow_y < mouse_y < crow_y + 200:
                crow_x = random.randint(0, SCREEN_WIDTH - 200)
                crow_y = random.randint(0, SCREEN_HEIGHT - 200)
            # {{ edit_2 }}
